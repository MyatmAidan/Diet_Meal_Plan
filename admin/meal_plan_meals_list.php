...
$result = $mysqli->query("SELECT mpm.id, mp.name AS meal_plan_name, m.name AS meal_name
                                FROM meal_plan_meals mpm
                                JOIN meal_plans mp ON mpm.meal_plan_id = mp.id
                                JOIN meals m ON mpm.meal_id = m.id LIMIT $limit OFFSET $offset");
?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.btn-delete-meal-plan-meal').forEach(function(btn) {
