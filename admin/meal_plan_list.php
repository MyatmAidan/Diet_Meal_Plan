                        ...
                        <?php else: ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="meal_plan_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary me-2">
                                            ပြင်ဆင်မည်
                                        </a>
                                        <button class="btn btn-sm btn-danger btn-delete-meal-plan" onclick="deleteFun(<?= $row['id'] ?>, 'mealPlanId')" data-id="<?= $row['id'] ?>">
                                            ဖျက်ရန်
                                        </button>
                                    </td>
                                </tr>
