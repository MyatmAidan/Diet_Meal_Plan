    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3 d-flex justify-content-between align-items-center">
                <h3 class="fw-bold mb-0">အစားအစာအစီအစဉ်များ</h3>
            ...
            <?php if (isset($_GET['msg']) && $_GET['msg'] == 'updated'): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    အစားအစာအစီအစဉ်အချက်အလက်များ အောင်မြင်စွာ ပြင်ဆင်ပြီးပါပြီ။
                        ...
                        <?php else: ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="meal_plan_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary me-2" title="ပြင်ဆင်မည်">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <button class="btn btn-sm btn-danger btn-delete-meal-plan" onclick="deleteFun(<?= $row['id'] ?>, 'mealPlanId')" data-id="<?= $row['id'] ?>" title="ဖျက်ရန်">
