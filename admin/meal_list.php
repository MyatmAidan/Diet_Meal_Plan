        ...
        <div class="col-12">
            <div class="mb-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-success fw-bold px-4" onclick="window.location.href='meal_create.php'">
                    <i class="bi bi-plus-lg me-2"></i> <?= __('အစားအစာအသစ်ထည့်ရန်') ?>
                </button>
            </div>
                ...
                <table class="table table-hover table-bordered align-middle mb-0 glass-table">
                    <thead class="table-light">
                        <tr>
                            <th><?= __('နံပါတ်') ?></th>
                            <th><?= __('အမည်') ?></th>
                            <th><?= __('အစားအစာအမျိုးအစား') ?></th>
                            <th><?= __('ပါဝင်ပစ္စည်းများ') ?></th>
                            ...
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-danger btn-delete-meal" onclick="deleteFun(<?= $row['id'] ?>, 'mealId')" data-id="<?= $row['id'] ?>" title="<?= __('ဖျက်မည်') ?>">
