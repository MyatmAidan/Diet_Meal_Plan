...
// Count total records
$count_result = $mysqli->query("SELECT COUNT(*) as total FROM user_diet_recommendations");
$total_rows = $count_result->fetch_assoc()['total'];
$total_pages = ceil($total_rows / $limit);

// Fetch paginated records
$result = $mysqli->query("SELECT udr.*, u.name AS user_name, mp.name AS meal_plan_name 
