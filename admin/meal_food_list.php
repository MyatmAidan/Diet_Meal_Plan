...
// Count total records
$count_result = $mysqli->query("SELECT COUNT(*) as total FROM meal_foods");
$total_rows = $count_result->fetch_assoc()['total'];
$total_pages = ceil($total_rows / $limit);

// Fetch paginated records
$result = $mysqli->query("SELECT mf.id, m.name AS meal_name, f.name AS food_name, mf.quantity
                                FROM meal_foods mf
                                JOIN meals m ON mf.meal_id = m.id
                                JOIN foods f ON mf.food_id = f.id LIMIT $limit OFFSET $offset");
?>
